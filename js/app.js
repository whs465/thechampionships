...
async function renderScores() {
  ...
  const scores = {
    data: [
      [1, 6, 1, 12, 3, 'ETH', 'Henok ', '@', '', '', '', '', 9, 0.25],
      [1, 4, 2, 0, 6, 'ETH', 'Aklog', '', '@', '', '', '', '', 0],
      [1, '', 3, 4, 5, 'CZE', 'Tomas ✈️', '', '', '@', '', 3, '', 0.25],
      [1, '', 4, 24, 1, 'ETH', 'Sami', '', '', '', '@', 9, 9, 0.5],
      [1, '', 5, 19, 2, 'COL', 'William', '', '', 9, 6, '@', '', 0.5],
      [1, '', 6, 9, 4, 'ETH', 'Tibebu', 2, '', '', 5, '', '@', 0.5],
      [2, 6, 1, 5, 3, 'ITA', 'Riccardo', '@', '', '', '', '', 4, 0.33],
      [2, 2, 2, 1, 4, 'ETH', 'Mohammed', '', '@', 0, '', '', '', 0.33],
      [2, '', 3, 12, 1, 'ETH', 'Abay ', '', 9, '@', '', '', '', 0.33],
      [2, '', 4, 0, 5, 'GBR', 'Paul ✈️', '', '', '', '@', '', '', 0],
      [2, '', 5, 0, 5, 'ETH', 'Alemayehu', '', '', '', '', '@', '', 0],
      [2, '', 6, 12, 1, 'ITA', 'Gianfranco', 9, '', '', '', '', '@', 0.33],
      [3, 7, 1, 0, 7, 'ETH', 'Girma', '@', '', '', '', '', '', '', 0],
      [3, 9, 2, 48, 1, 'ETH', 'Alemayehu', '', '@', 9, 9, 9, 9, '', 0.8],
      [3, '', 3, 35, 2, 'USA', 'Nicholas', '', 3, '@', 9, 9, '', 6, 0.8],
      [3, '', 4, 10, 6, 'ETH', 'Seyoum', '', 1, 4, '@', '', 2, '', 0.6],
      [3, '', 5, 16, 4, 'ETH', 'Jouhar', '', 4, 4, '', '@', 5, '', 0.6],
      [3, '', 6, 28, 3, 'BEL', 'Wouter ✈️', '', 3, '', 9, 9, '@', '', 0.6],
      [3, '', 7, 12, 5, 'ITA', 'Matteo', '', '', 9, '', '', '', '@', 0.2],
      ...
      [4, '', 7, 0, 4, 'USA', 'Mike', '', '', '', '', '', '', '@', 0],
      [5, 8, 1, 12, 4, 'ETH', 'Fassika', '@', '', '', 9, '', '', '', '', 0.33],
      [5, 4, 2, 0, 5, 'KEN', 'Sharon', '', '@', '', '', '', '', '', '', 0],
      [5, '', 3, 0, 5, 'ESP', 'Elena', '', '', '@', '', '', '', '', '', 0],
      [5, '', 4, 15, 3, 'ETH', 'Mahlet', 3, '', '', '@', '', '', 3, 6, 1],
      [5, '', 5, 0, 5, 'ETH', 'Yared', '', '', '', '', '@', '', '', '', 0],
      [5, '', 6, 0, 5, 'DEN', 'Kamille ✈️', '', '', '', '', '', '@', '', '', 0],
      [5, '', 7, 16, 2, 'JPN', 'Chiku', '', '', '', 9, '', '', '@', 3, 0.67],
      [5, '', 8, 24, 1, 'ETH', 'Haimanot', '', '', '', 9, '', '', 9, '@', 0.67],
    ],
    main: {
      totMatches: 79,
      numPlayers: 34,
      matchPlayed: 21,
      numCountries: 13,
      lastUpdated: '2022-04-23T14:25:00.000Z',
      showRank: 0,
    },
    error: false,
  }
