...
async function renderScores() {
  ...
  const scores = {
    data: [
      [1, 6, 1, 12, 4, 'ETH', 'Henok ', '@', '', '', '', '', 9, 0.25],
      [1, 5, 2, 0, 6, 'ETH', 'Aklog', '', '@', '', '', '', '', 0],
      [1, '', 3, 4, 5, 'CZE', 'Tomas ✈️', '', '', '@', '', 3, '', 0.25],
      [1, '', 4, 24, 2, 'ETH', 'Sami', '', '', '', '@', 9, 9, 0.5],
      [1, '', 5, 31, 1, 'COL', 'William', '', '', 9, 6, '@', 9, 0.75],
      [1, '', 6, 17, 3, 'ETH', 'Tibebu', 2, '', '', 5, 7, '@', 0.75],
      [2, 7, 1, 5, 3, 'ITA', 'Riccardo', '@', '', '', '', '', '', 4, 0.33],
      [2, 2, 2, 1, 4, 'ETH', 'Mohammed', '', '@', 0, '', '', '', '', 0.33],
      [2, '', 3, 12, 1, 'ETH', 'Abay ', '', 9, '@', '', '', '', '', 0.33],
      [2, '', 4, 0, 5, 'GBR', 'Paul ✈️', '', '', '', '@', '', '', '', 0],
      [2, '', 5, 0, 5, 'ETH', 'Alemayehu', '', '', '', '', '@', '', '', 0],
      [2, '', 6, 0, 5, 'EGY', 'Mohamed', '', '', '', '', '', '@', '', 0],
      [2, '', 7, 12, 1, 'ITA', 'Gianfranco', 9, '', '', '', '', '', '@', 0.33],
      [3, 7, 1, 0, 7, 'ETH', 'Girma', '@', '', '', '', '', '', '', 0],
      [3, 10, 2, 60, 1, 'ETH', 'Alemayehu', '', '@', 9, 9, 9, 9, 9, 1],
      [3, '', 3, 35, 2, 'USA', 'Nicholas', '', 3, '@', 9, 9, '', 6, 0.8],
      [3, '', 4, 10, 6, 'ETH', 'Seyoum', '', 1, 4, '@', '', 2, '', 0.6],
      [3, '', 5, 16, 5, 'ETH', 'Jouhar', '', 4, 4, '', '@', 5, '', 0.6],
      [3, '', 6, 28, 3, 'BEL', 'Wouter ✈️', '', 3, '', 9, 9, '@', '', 0.6],
      [3, '', 7, 20, 4, 'ITA', 'Matteo', '', 7, 9, '', '', '', '@', 0.4],
      [4, 7, 1, 1, 3, 'LTU', 'Marius ✈️', '@', '', 0, '', '', '', '', 0.5],
      [4, 2, 2, 0, 4, 'ETH', 'Workafes', '', '@', '', '', '', '', '', 0],
      [4, '', 3, 24, 1, 'ETH', 'Mesfin', 9, '', '@', '', '', 9, '', 1],
      [4, '', 4, 0, 4, 'CZE', 'Pavel', '', '', '', '@', '', '', '', 0],
      [4, '', 5, 0, 4, 'NED', 'Janno ✈️', '', '', '', '', '@', '', '', 0],
      [4, '', 6, 8, 2, 'ETH', 'Bini', '', '', 7, '', '', '@', '', 0.5],
      [4, '', 7, 0, 4, 'USA', 'Mike', '', '', '', '', '', '', '@', 0],
      [5, 8, 1, 12, 5, 'ETH', 'Fassika', '@', '', '', 9, '', '', '', '', 0.25],
      [5, 6, 2, 15, 3, 'KEN', 'Sharon', '', '@', '', '', '', '', 7, 6, 0.5],
      [5, '', 3, 0, 6, 'ESP', 'Elena', '', '', '@', '', '', '', '', '', 0],
      [5, '', 4, 15, 3, 'ETH', 'Mahlet', 3, '', '', '@', '', '', 3, 6, 0.75],
      [5, '', 5, 0, 6, 'ETH', 'Yared', '', '', '', '', '@', '', '', '', 0],
      [5, '', 6, 0, 6, 'DEN', 'Kamille', '', '', '', '', '', '@', '', '', 0],
      [5, '', 7, 28, 2, 'JPN', 'Chiku', '', 9, '', 9, '', '', '@', 3, 0.75],
      [5, '', 8, 36, 1, 'ETH', 'Haimanot', '', 9, '', 9, '', '', 9, '@', 0.75],
    ],
    main: {
      totMatches: 81,
      numPlayers: 35,
      matchPlayed: 25,
      numCountries: 14,
      lastUpdated: '2022-04-28T04:18:00.000Z',
      showRank: 0,
    },
    error: false,
  }
