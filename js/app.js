...
async function renderScores() {
  ...
  const scores = {
    data: [
      [1, 7, 1, 36, 1, 'ITA', 'Samuel', '@', 9, 9, 3, '', 7, '', 0.67],
      [1, 9, 2, 34, 2, 'SIN', 'Lim', 4, '@', 9, 8, 7, '', '', 0.67],
      [1, '', 3, 21, 6, 'PHI', 'Ariez', 8, 4, '@', '', 6, '', '', 0.5],
      [1, '', 4, 33, 3, 'COL', 'William', 9, 9, '', '@', '', 8, '', 0.5],
      [1, '', 5, 24, 4, 'IND', 'Vik', '', 9, 9, '', '@', '', '', 0.33],
      [1, '', 6, 24, 4, 'ITA', 'Paolo', 9, '', '', 9, '', '@', '', 0.33],
      [1, '', 7, 0, 7, 'GRE', 'Vas', '', '', '', '', '', '', '@', 0],
    ],
    main: {
      totMatches: 12,
      ...
      matchPlayed: 9,
      numCountries: 6,
      lastUpdated: '2024-02-07T04:30:00.000Z',
      showRank: 1,
    },
    error: false,
  }
