...
async function renderScores() {
  ...
  const scores = {
    data: [
      [1, 6, 1, 35, 4, 'ETH', 'Aklog ', '@', '', 3, 9, 9, 6, 0.8],
      [1, 14, 2, 31, 5, 'ETH', 'Tibebu', '', '@', 9, 4, 5, 7, 0.8],
      [1, '', 3, 53, 2, 'ETH', 'Abay ', 9, 8, '@', 9, 9, 7, 1],
      [1, '', 4, 43, 3, 'CZE', 'Tomas', 4, 9, 1, '@', 9, 9, 1],
      [1, '', 5, 31, 5, 'COL', 'William', 3, 9, 4, 6, '@', 2, 1],
      [1, '', 6, 57, 1, 'ETH', 'Henok', 9, 9, 9, 8, 9, '@', 1],
      [2, 6, 1, 60, 1, 'ETH', 'Sami O.🥇', '@', 9, 9, 9, 9, 9, 1],
      [2, 12, 2, 43, 2, 'ETH', 'Mohammed', 6, '@', 9, 9, '', 9, 0.8],
      [2, '', 3, 11, 6, 'NED', 'Paul', 2, 1, '@', '', 5, '', 0.6],
      [2, '', 4, 22, 5, 'ETH', 'Jouhar', 3, 1, '', '@', 6, 8, 0.8],
      [2, '', 5, 43, 2, 'ITA', 'Riccardo B.', 6, '', 9, 9, '@', 9, 0.8],
      [2, '', 6, 27, 4, 'ETH', 'Seyoum', 4, 3, '', 9, 5, '@', 0.8],
      [3, 6, 1, 24, 1, 'ETH', 'Girma', '@', 9, '', '', 9, '', 1],
      [3, 3, 2, 15, 2, 'ETH', 'Mesay', 2, '@', '', '', 9, '', 1],
      [3, '', 3, 0, 4, 'EGY', 'Mohamed', '', '', '@', '', '', '', 0],
      [3, '', 4, 0, 4, 'ETH', 'Nebiat', '', '', '', '@', '', '', 0],
      [3, '', 5, 7, 3, 'ITA', 'Riccardo R.', 4, 1, '', '', '@', '', 1],
      [3, '', 6, 0, 4, 'ETH', 'Migo ', '', '', '', '', '', '@', 0],
      [4, 6, 1, 54, 1, 'ETH', 'Mickey', '@', 9, 5, 9, 9, 9, 1],
      [4, 12, 2, 38, 4, 'CZE', 'Pavel', 5, '@', 7, '', 9, 9, 0.8],
      [4, '', 3, 43, 2, 'ETH', 'Mesfin', 9, 9, '@', '', 6, 9, 0.8],
      [4, '', 4, 17, 6, 'GBR', 'Francis', 4, '', '', '@', '', 9, 0.4],
      [4, '', 5, 39, 3, 'ETH', 'Girum', 6, 7, 9, '', '@', 9, 0.8],
      [4, '', 6, 27, 5, 'LTU', 'Marius', 2, 3, 5, 6, 6, '@', 1],
      [5, 6, 1, 23, 3, 'KEN', 'Sharon', '@', '', 9, 5, 4, '', 0.75],
      [5, 7, 2, 15, 4, 'ETH', 'Konjit', '', '@', 9, '', 2, '', 0.5],
      [5, '', 3, 15, 4, 'ETH', 'Mahlet', 6, 6, '@', 0, '', '', 0.75],
      [5, '', 4, 32, 2, 'ETH', 'Anteneh', 9, '', 9, '@', 7, '', 0.75],
      [5, '', 5, 36, 1, 'ETH', 'Sami M.', 9, 9, '', 9, '@', '', 0.75],
      [5, '', 6, 0, 6, 'ETH', 'Bamlak', '', '', '', '', '', '@', 0],
    ],
    main: {
      totMatches: 27,
      numPlayers: 30,
      matchPlayed: 48,
      numCountries: 9,
      lastUpdated: '2022-02-10T14:08:00.000Z',
      showRank: 1,
    },
    error: false,
  }
