...
async function renderScores() {
  ...
  //     [2, '', 4, 0, 1, 'GBR', 'Paul', '', '', '', '@', '', '', 0],
  //     [2, '', 5, 0, 1, 'ETH', 'Girum', '', '', '', '', '@', '', 0],
  //     [2, '', 6, 0, 1, 'ITA', 'Gianfranco', '', '', '', '', '', '@', 0],
  //     [3, 7, 1, 0, 3, 'ETH', 'Girma', '@', '', '', '', '', '', '', 0],
  //     [3, 1, 2, 0, 3, 'ETH', 'Alex', '', '@', '', '', '', '', '', 0],
  //     [3, '', 3, 0, 3, 'USA', 'Nicolas', '', '', '@', '', '', '', '', 0],
  //     [3, '', 4, 0, 3, 'ETH', 'Seyoum', '', '', '', '@', '', '', '', 0],
  //     [3, '', 5, 6, 2, 'ETH', 'Jouhar', '', '', '', '', '@', 5, '', 1],
  //     [3, '', 6, 12, 1, 'BEL', 'Wouter', '', '', '', '', 9, '@', '', 1],
  //     [3, '', 7, 0, 3, 'ITA', 'Matteo', '', '', '', '', '', '', '@', 0],
  //     [4, 7, 1, 1, 2, 'LTU', 'Marius', '@', '', 0, '', '', '', '', 1],
  //     [4, 1, 2, 0, 3, 'ETH', 'Workafes', '', '@', '', '', '', '', '', 0],
  //     [4, '', 3, 12, 1, 'ETH', 'Mesfin', 9, '', '@', '', '', '', '', 1],
  //     [4, '', 4, 0, 3, 'CZE', 'Pavel', '', '', '', '@', '', '', '', 0],
  //     [4, '', 5, 0, 3, 'NED', 'Janno', '', '', '', '', '@', '', '', 0],
  //     [4, '', 6, 0, 3, 'ETH', 'Bini', '', '', '', '', '', '@', '', 0],
  //     [4, '', 7, 0, 3, 'USA', 'Mike', '', '', '', '', '', '', '@', 0],
  //     [5, 7, 1, 0, 1, 'ETH', 'Fassika', '@', '', '', '', '', '', '', 0],
  //     [5, 0, 2, 0, 1, 'ETH', 'Anteneh', '', '@', '', '', '', '', '', 0],
  //     [5, '', 3, 0, 1, 'KEN', 'Sharon', '', '', '@', '', '', '', '', 0],
  //     [5, '', 4, 0, 1, 'ETH', 'Mahlet', '', '', '', '@', '', '', '', 0],
  //     [5, '', 5, 0, 1, 'ETH', 'Yared', '', '', '', '', '@', '', '', 0],
  //     [5, '', 6, 0, 1, 'DEN', 'Kamille', '', '', '', '', '', '@', '', 0],
  //     [5, '', 7, 0, 3, 'JPN', 'Chiku', '', '', '', '', '', '', '@', 0],
  //   ],
  //   main: {
  //     totMatches: 90,
  ...
  //     matchPlayed: 3,
  //     numCountries: 12,
  //     lastUpdated: '2022-04-08T08:30:00.000Z',
  //     showRank: 0,
  //   },
  //   error: false,
  // }
