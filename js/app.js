...
async function renderScores() {
  ...
  const scores = {
    data: [
      ...
      [4, 11, 2, 38, 2, 'CZE', 'Pavel', 5, '@', 7, '', 9, 9, 0.8],
      [4, '', 3, 36, 3, 'ETH', 'Mesfin', 9, 9, '@', '', '', 9, 0.6],
      [4, '', 4, 17, 6, 'GBR', 'Francis', 4, '', '', '@', '', 9, 0.4],
      [4, '', 5, 27, 4, 'ETH', 'Girum', 6, 7, '', '', '@', 9, 0.6],
      [4, '', 6, 27, 4, 'LTU', 'Marius', 2, 3, 5, 6, 6, '@', 1],
    ...
    main: {
      ...
      matchPlayed: 47,
      numCountries: 9,
      lastUpdated: '2022-02-09T14:19:00.000Z',
      showRank: 1,
    },
    error: false,
  }
