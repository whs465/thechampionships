...
async function renderScores() {
  ...
  const scores = {
    data: [
      [1, 6, 1, 0, 5, 'ETH', 'Henok ', '@', '', '', '', '', '', 0],
      [1, 3, 2, 0, 5, 'ETH', 'Aklog', '', '@', '', '', '', '', 0],
      [1, '', 3, 4, 4, 'CZE', 'Tomas ✈️', '', '', '@', '', 3, '', 0.33],
      [1, '', 4, 24, 1, 'ETH', 'Sami', '', '', '', '@', 9, 9, 0.67],
      [1, '', 5, 19, 2, 'COL', 'William', '', '', 9, 6, '@', '', 0.67],
      [1, '', 6, 6, 3, 'ETH', 'Tibebu', '', '', '', 5, '', '@', 0.33],
      [2, 6, 1, 5, 2, 'ITA', 'Riccardo', '@', '', '', '', '', 4, 1],
      [2, 1, 2, 0, 3, 'ETH', 'Mohammed', '', '@', '', '', '', '', 0],
      [2, '', 3, 0, 3, 'ETH', 'Abay ', '', '', '@', '', '', '', 0],
      [2, '', 4, 0, 3, 'GBR', 'Paul ✈️', '', '', '', '@', '', '', 0],
      [2, '', 5, 0, 3, 'ETH', 'Alemayehu', '', '', '', '', '@', '', 0],
      [2, '', 6, 12, 1, 'ITA', 'Gianfranco', 9, '', '', '', '', '@', 1],
      [3, 7, 1, 0, 7, 'ETH', 'Girma', '@', '', '', '', '', '', '', 0],
      [3, 8, 2, 48, 1, 'ETH', 'Alemayehu', '', '@', 9, 9, 9, 9, '', 0.8],
      [3, '', 3, 23, 3, 'USA', 'Nicholas', '', 3, '@', 9, '', '', 6, 0.6],
      [3, '', 4, 10, 6, 'ETH', 'Seyoum', '', 1, 4, '@', '', 2, '', 0.6],
      [3, '', 5, 11, 5, 'ETH', 'Jouhar', '', 4, '', '', '@', 5, '', 0.4],
      [3, '', 6, 28, 2, 'BEL', 'Wouter ✈️', '', 3, '', 9, 9, '@', '', 0.6],
      [3, '', 7, 12, 4, 'ITA', 'Matteo', '', '', 9, '', '', '', '@', 0.2],
      ...
      [4, '', 7, 0, 4, 'USA', 'Mike', '', '', '', '', '', '', '@', 0],
      [5, 8, 1, 12, 1, 'ETH', 'Fassika', '@', '', '', 9, '', '', '', '', 0.33],
      [5, 2, 2, 0, 5, 'KEN', 'Sharon', '', '@', '', '', '', '', '', '', 0],
      [5, '', 3, 0, 5, 'ESP', 'Elena', '', '', '@', '', '', '', '', '', 0],
      [5, '', 4, 4, 4, 'ETH', 'Mahlet', 3, '', '', '@', '', '', '', '', 0.33],
      [5, '', 5, 7, 3, 'ETH', 'Yared', '', '', '', '', '@', '', '', 6, 0.33],
      [5, '', 6, 0, 5, 'DEN', 'Kamille ✈️', '', '', '', '', '', '@', '', '', 0],
      [5, '', 7, 0, 5, 'JPN', 'Chiku', '', '', '', '', '', '', '@', '', 0],
      [5, '', 8, 12, 1, 'ETH', 'Haimanot', '', '', '', 9, '', '', '', '@', 0.33],
    ],
    main: {
      totMatches: 84,
      numPlayers: 34,
      matchPlayed: 15,
      numCountries: 13,
      lastUpdated: '2022-04-20T09:03:00.000Z',
      showRank: 0,
    },
    error: false,
  }
