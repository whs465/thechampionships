...
async function renderScores() {
  ...
  const scores = {
    data: [
      [1, 6, 1, 0, 1, 'GBR', 'Bruno', '@', '', '', '', '', '', 0],
      [1, 0, 2, 0, 1, 'SRB', 'Milan', '', '@', '', '', '', '', 0],
      [1, '', 3, 0, 1, 'COL', 'William', '', '', '@', '', '', '', 0],
      [1, '', 4, 0, 1, 'ITA', 'Samuel', '', '', '', '@', '', '', 0],
      [1, '', 5, 0, 1, 'SIN', 'Lim', '', '', '', '', '@', '', 0],
      [1, '', 6, 0, 1, 'SRB', 'Jorge', '', '', '', '', '', '@', 0],
      [2, 7, 1, 0, 1, 'GBR', 'Natasha', '@', '', '', '', '', '', '', 0],
      [2, 0, 2, 0, 1, 'UAE', 'Seale', '', '@', '', '', '', '', '', '', 0],
      [2, '', 3, 0, 1, 'CAM', 'Loyd', '', '', '@', '', '', '', '', 0],
      [2, '', 4, 0, 1, 'UAE', 'Player 10', '', '', '', '@', '', '', '', 0],
      [2, '', 5, 0, 1, 'UAE', 'Player 11', '', '', '', '', '@', '', '', 0],
      [2, '', 6, 0, 1, 'UAE', 'Player 12', '', '', '', '', '', '@', '', 0],
      [2, '', 7, 0, 1, 'UAE', 'Player 13', '', '', '', '', '', '', '@', 0],
    ],
    main: {
      totMatches: 36,
      numPlayers: 13,
      matchPlayed: 0,
      numCountries: 7,
      lastUpdated: '2022-12-15T11:08:00.000Z',
      showRank: 0,
    },
    error: false,
  }
