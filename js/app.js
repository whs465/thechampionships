...
async function renderScores() {
  ...
  // const scores = {
  //   data: [
  //     [1, 7, 1, 0, 5, 'ETH', 'Henok 👑', '@', '', '', '', '', '', '', 0],
  //     [1, 4, 2, 12, 4, 'ETH', 'Abay ', '', '@', '', '', 9, '', '', 0.33],
  //     [1, '', 3, 20, 2, 'CZE', 'Tomas', '', '', '@', '', 9, 7, '', 0.67],
  //     [1, '', 4, 0, 5, 'ETH', 'Aklog', '', '', '', '@', '', '', '', 0],
  //     [1, '', 5, 15, 3, 'ETH', 'Sami O.', '', 1, 6, '', '@', 5, '', 1],
  //     [1, '', 6, 24, 1, 'ETH', 'Mohammed', '', '', 9, '', 9, '@', '', 0.67],
  //     [1, '', 7, 0, 5, 'COL', 'William', '', '', '', '', '', '', '@', 0],
  //     [2, 7, 1, 0, '', 'ETH', 'Tibebu', '@', '', '', '', '', '', '', 0],
  ...
  //     [4, 8, 1, 12, 1, 'ITA', 'Riccardo R.', '@', '', 9, '', '', '', '', '', 1],
  //     [4, 1, 2, 0, '', 'LTU', 'Marius', '', '@', '', '', '', '', '', '', 0],
  //     [4, '', 3, 8, '', 'NED', 'Janno', 7, '', '@', '', '', '', '', '', 1],
  //     [4, '', 4, 0, '', 'CZE', 'Pavel', '', '', '', '@', '', '', '', '', 0],
  //     [4, '', 5, 0, '', 'ETH', 'Sami M.', '', '', '', '', '@', '', '', '', 0],
  ...
  //     [4, '', 7, 0, '', 'ITA', 'Matteo', '', '', '', '', '', '', '@', '', 0],
  //     [4, '', 8, 0, 3, 'ETH', 'Migo', '', '', '', '', '', '', '', '@', 0],
  //     [5, 7, 1, 0, '', 'ETH', 'Hallelujah', '@', '', '', '', '', '', '', 0],
  //     [5, 1, 2, 12, 1, 'KEN', 'Sharon', '', '@', 9, '', '', '', '', 1],
  //     [5, '', 3, 2, '', 'ETH', 'Konjit', '', 1, '@', '', '', '', '', 1],
  //     [5, '', 4, 0, '', 'ETH', 'Mahlet', '', '', '', '@', '', '', '', 0],
  //     [5, '', 5, 0, '', 'ETH', 'Fassika', '', '', '', '', '@', '', '', 0],
  //     [5, '', 6, 0, '', 'ETH', 'Luladay', '', '', '', '', '', '@', '', 0],
  //     [5, '', 7, 0, '', 'ETH', 'Haimanot', '', '', '', '', '', '', '@', 0],
  //   ],
  //   main: {
  //     totMatches: 105,
  //     numPlayers: 36,
  //     matchPlayed: 7,
  //     numCountries: 9,
  //     lastUpdated: '2022-02-17T12:27:00.000Z',
  //     showRank: 0,
  //   },
  //   error: false,
  // }
  ...
  for (i = 0; i < scores.data.length; i++) {
    ...
    if (playerRank === '') {
      htmlPoints = `<td class="text-center"><i class="mdi mdi-cancel text-muted"></i></td>`
    }
    ...
    cellP1 =
      p1 === '@'
        ? boxSeparatorBg
        : playerRank === ''
        ? `<td class="text-center bg-soft-primary-table"><i class="mdi mdi-cancel text-muted"></i></td>`
    ...
    cellP2 =
      p2 === '@'
        ? boxSeparator
        : playerRank === ''
        ? `<td class="text-center"><i class="mdi mdi-cancel text-muted"></i></td>`
