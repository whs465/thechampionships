...
async function renderScores() {
  ...
  const scores = {
    data: [
      ...
      [2, 6, 1, 0, 5, 'GRE', 'Vas ', '@', '', '', '', '', '', 0],
      [2, 2, 2, 0, 5, 'PHI', 'Ariez', '', '@', '', '', '', '', 0],
      [2, '', 3, 4, 4, 'CAM', 'Loic', '', '', '@', '', 3, '', 0.33],
      [2, '', 4, 12, 1, 'GBR', 'Seale', '', '', '', '@', '', 9, 0.33],
      [2, '', 5, 12, 1, 'CAM', 'Brad', '', '', 9, '', '@', '', 0.33],
      [2, '', 6, 5, 3, 'RUS', 'Pavel', '', '', '', 4, '', '@', 0.33],
    ],
    main: {
      totMatches: 27,
      numPlayers: 12,
      matchPlayed: 2,
      numCountries: 10,
      lastUpdated: '2024-02-25T16:11:00.000Z',
      showRank: 0,
    },
    error: false,
  }
