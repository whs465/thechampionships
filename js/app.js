...
async function renderScores() {
  ...
  const scores = {
    data: [
      ...
      [3, 7, 1, 0, 1, 'ETH', 'Girma', '@', '', '', '', '', '', '', 0],
      [3, 0, 2, 0, 1, 'ETH', 'Alex', '', '@', '', '', '', '', '', 0],
      [3, '', 3, 0, 1, 'USA', 'Nicolas', '', '', '@', '', '', '', '', 0],
      [3, '', 4, 0, 1, 'ETH', 'Seyoum', '', '', '', '@', '', '', '', 0],
      [3, '', 5, 0, 1, 'ETH', 'Jouhar', '', '', '', '', '@', '', '', 0],
      [3, '', 6, 0, 1, 'BEL', 'Wouter', '', '', '', '', '', '@', '', 0],
      [3, '', 7, 0, 1, 'ITA', 'Matteo', '', '', '', '', '', '', '@', 0],
    ...
    main: {
      ...
      matchPlayed: 0,
      numCountries: 12,
      lastUpdated: '2022-04-06T05:56:00.000Z',
      showRank: 0,
    },
    error: false,
  }
