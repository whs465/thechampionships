...
async function renderScores() {
  ...
  const scores = {
    data: [
      [1, 7, 1, 0, 1, 'ETH', 'Henok', '@', '', '', '', '', '', '', 0],
      [1, 0, 2, 0, 1, 'ETH', 'Abay ', '', '@', '', '', '', '', '', 0],
      [1, '', 3, 0, 1, 'CZE', 'Tomas', '', '', '@', '', '', '', '', 0],
      [1, '', 4, 0, 1, 'ETH', 'Aklog', '', '', '', '@', '', '', '', 0],
      [1, '', 5, 0, 1, 'ETH', 'Sami O.', '', '', '', '', '@', '', '', 0],
      [1, '', 6, 0, 1, 'ETH', 'Mohammed', '', '', '', '', '', '@', '', 0],
      [1, '', 7, 0, 1, 'COL', 'William', '', '', '', '', '', '', '@', 0],
      [2, 6, 1, 0, 1, 'ETH', 'Tibebu', '@', '', '', '', '', '', 0],
      [2, 0, 2, 0, 1, 'ITA', 'Riccardo B.', '', '@', '', '', '', '', 0],
      [2, '', 3, 0, 1, 'ETH', 'Seyoum', '', '', '@', '', '', '', 0],
      [2, '', 4, 0, 1, 'ETH', 'Girma', '', '', '', '@', '', '', 0],
      [2, '', 5, 0, 1, 'ETH', 'Solomon', '', '', '', '', '@', '', 0],
      [2, '', 6, 0, 1, 'GBR', 'Paul', '', '', '', '', '', '@', 0],
      [3, 6, 1, 0, 1, 'ETH', 'Jouhar', '@', '', '', '', '', '', 0],
      [3, 0, 2, 0, 1, 'ETH', 'Mesay', '', '@', '', '', '', '', 0],
      [3, '', 3, 0, 1, 'MOR', 'Hicham', '', '', '@', '', '', '', 0],
