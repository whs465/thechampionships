...
async function renderScores() {
  ...
  const scores = {
    data: [
      [1, 7, 1, 48, 3, 'ITA', 'Samuel', '@', 9, 9, 3, 5, 7, 5, 1],
      [1, 17, 2, 44, 5, 'SIN', 'Lim', 4, '@', 9, 8, 7, 5, 3, 1],
      [1, '', 3, 26, 6, 'PHI', 'Ariez', 8, 4, '@', 4, 6, '', '', 0.67],
      [1, '', 4, 69, 1, 'COL', 'William', 9, 9, 9, '@', 9, 8, 9, 1],
      [1, '', 5, 53, 2, 'IND', 'Vik', 9, 9, 9, 7, '@', 8, '', 0.83],
      [1, '', 6, 48, 3, 'ITA', 'Paolo', 9, 9, '', 9, 9, '@', '', 0.67],
    ...
    main: {
      ...
      matchPlayed: 16,
      numCountries: 6,
      lastUpdated: '2024-02-18T04:58:00.000Z',
      showRank: 1,
    },
    error: false,
  }
