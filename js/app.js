...
async function renderScores() {
  ...
  const scores = {
    data: [
      [1, 5, 1, 0, 1, 'ETH', 'Aklog ', '@', '', '', '', '', 0],
      [1, '', 2, 0, 1, 'ETH', 'Tibetu', '', '@', '', '', '', 0],
      [1, '', 3, 0, 1, 'ETH', 'Abay ', '', '', '@', '', '', 0],
      [1, '', 4, 0, 1, 'CZE', 'Tomas', '', '', '', '@', '', 0],
      [1, '', 5, 0, 1, 'COL', 'William', '', '', '', '', '@', 0],
      [2, 5, 1, 0, 1, 'ETH', 'Sami O.', '@', '', '', '', '', 0],
      [2, '', 2, 0, 1, 'ETH', 'Mohammed', '', '@', '', '', '', 0],
      [2, '', 3, 0, 1, 'MOR', 'Hicham', '', '', '@', '', '', 0],
      [2, '', 4, 0, 1, 'ETH', 'Jouhar', '', '', '', '@', '', 0],
      [2, '', 5, 0, 1, 'ETH', 'Seyoum', '', '', '', '', '@', 0],
      [3, 6, 1, 0, 1, 'ETH', 'Chenbu', '@', '', '', '', '', '', 0],
      [3, '', 2, 0, 1, 'ITA', 'Riccardo B.', '', '@', '', '', '', '', 0],
      [3, '', 3, 0, 1, 'EGY', 'Mohamed', '', '', '@', '', '', '', 0],
      [3, '', 4, 0, 1, 'ETH', 'Nebiat', '', '', '', '@', '', '', 0],
      [3, '', 5, 0, 1, 'ITA', 'Riccardo R.', '', '', '', '', '@', '', 0],
      [3, '', 6, 0, 1, 'ETH', 'Migo ', '', '', '', '', '', '@', 0],
      [4, 6, 1, 0, 1, 'ETH', 'Mickey', '@', '', '', '', '', '', 0],
      [4, '', 2, 0, 1, 'CZE', 'Pavel', '', '@', '', '', '', '', 0],
      [4, '', 3, 0, 1, 'ETH', 'Mesfin', '', '', '@', '', '', '', 0],
      [4, '', 4, 0, 1, 'GBR', 'Francis', '', '', '', '@', '', '', 0],
      [4, '', 5, 0, 1, 'ETH', 'Girum', '', '', '', '', '@', '', 0],
      [4, '', 6, 0, 1, 'LTU', 'Marius', '', '', '', '', '', '@', 0],
      [5, 6, 1, 0, 1, 'KEN', 'Sharon', '@', '', '', '', '', '', 0],
      [5, '', 2, 0, 1, 'ETH', 'Konjit', '', '@', '', '', '', '', 0],
      [5, '', 3, 0, 1, 'ETH', 'Mahlet', '', '', '@', '', '', '', 0],
      [5, '', 4, 0, 1, 'ETH', 'Anteneh', '', '', '', '@', '', '', 0],
      [5, '', 5, 0, 1, 'ETH', 'Sami M.', '', '', '', '', '@', '', 0],
    ...
    main: {
      ...
      matchPlayed: 0,
      numCountries: 9,
      lastUpdated: '2022-01-10T09:13:00.000Z',
      showRank: 0,
    },
    error: false,
  }
