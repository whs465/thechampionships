...
async function renderScores() {
  ...
  //     [3, '', 6, 0, 1, 'ETH', 'Migo ', '', '', '', '', '', '@', 0],
  //     [4, 6, 1, 0, 4, 'ETH', 'Mickey', '@', '', '', '', '', '', 0],
  //     [4, '', 2, 0, 4, 'CZE', 'Pavel', '', '@', '', '', '', '', 0],
  //     [4, '', 3, 12, 2, 'ETH', 'Mesfin', '', '', '@', '', '', 9, 0.5],
  //     [4, '', 4, 0, 4, 'GBR', 'Francis', '', '', '', '@', '', '', 0],
  //     [4, '', 5, 12, 2, 'ETH', 'Girum', '', '', '', '', '@', 9, 0.5],
  //     [4, '', 6, 13, 1, 'LTU', 'Marius', '', '', 5, '', 6, '@', 1],
  ...
  //     matchPlayed: 5,
  //     numCountries: 9,
  //     lastUpdated: '2022-01-14T17:56:00.000Z',
  //     showRank: 0,
  //   },
  //   error: false,
  // }
